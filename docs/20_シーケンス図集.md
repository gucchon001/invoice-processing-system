...
**🎉 2025年7月28日更新**: **40カラム新機能対応**により、外貨換算・承認ワークフロー・freee連携の3つの新機能処理フローが追加され、エンタープライズレベルの包括的なシーケンス図集が完成しました。
...
7. [💱 外貨換算処理](#外貨換算処理) ★v2.0 NEW★
8. [✅ 承認ワークフロー処理](#承認ワークフロー処理) ★v2.0 NEW★
9. [📊 freee連携処理](#freee連携処理) ★v2.0 NEW★
...
sequenceDiagram
    ...
    Note over UWE: 📊 請求書データ拡張<br/>- exchange_rate: 149.50<br/>- jpy_amount: 149500.00<br/>- currency: "USD"
